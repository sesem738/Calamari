...
import os
import sys
# sys.path.append(r"C:\Users\gaikins2015\CARLA\PythonAPI\carla\dist\carla-0.9.13-py3.7-win-amd64.egg")
sys.path.append(r'C:\Users\the_3\Downloads\CARLA_0.9.13\WindowsNoEditor\PythonAPI\carla\dist\carla-0.9.13-py3.7-win-amd64.egg')
